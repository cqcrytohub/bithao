...
const char * const BITCOIN_CONF_FILENAME = "bithao.conf";
const char * const BITCOIN_PID_FILENAME = "bithaod.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bithao";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bithao";
#else
    // Unix
