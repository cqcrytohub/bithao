...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cqcrytohub/bithao>";
    const std::string URL_WEBSITE = "<https://bithao.org>";
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if bithao is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if bithao is started while in a temporary directory.\n",
